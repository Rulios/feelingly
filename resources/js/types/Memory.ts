 ...
 * TO DO:
 * 
 * - DECOUPLE MANY OF THE PROPERTIES FROM THIS TYPE. AND USING INTERSECTION TYPES OR 
 *      INHERITANCE TO BUILD THESE TYPES. THIS WILL ALLOW INDIVIDUAL PROPERTIES TO BE ON THEIR
 *      CORRESPONDENT TYPE.
 *      
 */
...
interface Memory {
    ...
    user_profile_image?: string; //url of author's profile's image
